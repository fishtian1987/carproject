...
${OBJECTDIR}/utils/smswork.o: utils/smswork.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iutils -Ibase -Ihttp -Imdm -I/www/server/mysql/include -Imysql -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/smswork.o utils/smswork.cpp

${OBJECTDIR}/utils/taskwork.o: utils/taskwork.cpp
	${MKDIR} -p ${OBJECTDIR}/utils
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iutils -Ibase -Ihttp -Imdm -I/www/server/mysql/include -Imysql -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/utils/taskwork.o utils/taskwork.cpp
